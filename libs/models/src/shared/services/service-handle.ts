...
export type ErrorOptionsOutputs = Error | HttpException | string | undefined;
...
export type MakeError = (input: MakeErrorInput) => ErrorOptionsOutputs;
